...
A view is a screen. `views::battle` is the game and `views::menu` is the screen before it; `views::Views` is the egui plumbing they share, and `views::theme` is everything visual.
