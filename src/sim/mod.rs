...
pub use rule::{
    blast_reach, next_cell, Chance, Neighbours, RuleFn, Then, BORN_ON, DEFAULT_TORUS, ICE_COST,
    LEVEL_ADJUST, LEVEL_EBB, LEVEL_FALL, LEVEL_SPREAD, LIFE_COST, MINE_COST, MINE_DRAIN,
